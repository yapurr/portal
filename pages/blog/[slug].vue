...
const author = computed(() => {
  const { weibo, avatar, gravatar, author } = post.value
  return { weibo, avatar, gravatar, author }
})
        ...
        <article class="dark:xl:divide-gray-700 xl:divide-gray-200 xl:divide-y">
          ...
          <div
            ...
            <div
              ...
              <TheAuthor v-bind="author" />
              <TableOfContents :post="post" class="hidden xl:block"></TableOfContents>
            </div>
            ...
            <div class="hidden">
              <footer
                ...
                <NuxtLink class="block pt-8" to="/blog">Back to the blog
                </NuxtLink>
              </footer>
            </div>
          </div>
